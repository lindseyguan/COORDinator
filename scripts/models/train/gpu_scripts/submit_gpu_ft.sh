...
OUTDIR="/data1/groups/keatinglab/fosterb/running_COORDinator_experiments/multichain_wds_full_ft_ppb_all_no_dropout_mse_only_higher_lr_no_regularization_R3"
mkdir -p ${OUTDIR}
