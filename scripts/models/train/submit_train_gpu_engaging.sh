...
VALIDATION=${10}
TEST=${11}
echo "$DATANAME $MSA $RUNNAME $OUTPUTDIR $LOGDIR"
...
sed \
  ...
  <run_train_gpu_engaging.sh \
  >bash_files/run_${DATANAME}_${RUNNAME}_run_gpu_engaging.sh
jid0=$(sbatch --parsable bash_files/run_${DATANAME}_${RUNNAME}_run_gpu_engaging.sh)
echo $jid0