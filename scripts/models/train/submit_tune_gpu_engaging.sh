...
sed \
  ...
  <run_tune_gpu_engaging.sh \
  >bash_files/run_${DATANAME}_${RUNNAME}_tune_gpu_engaging.sh
jid0=$(sbatch --parsable bash_files/run_${DATANAME}_${RUNNAME}_tune_gpu_engaging.sh)
echo $jid0