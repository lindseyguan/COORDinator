...
VALIDATION=${10}
TEST=${11}
echo "$DATANAME $MSADATASET $RUNNAME $OUTPUTDIR $LOGDIR"
...
sed \
  ...
  <run_train_gpu_dave.sh \
  >bash_files/run_${DATANAME}_${RUNNAME}_run_gpu_dave.sh
jid0=$(bash bash_files/run_${DATANAME}_${RUNNAME}_run_gpu_dave.sh)
echo $jid0