...
def load_model(args, model_hparams=None, run_hparams=None):
    ...
    if args.from_wds:
        ...
        test_dataset, test_dataset_target, test_dataset_binder = load_data(args.dataset, args.pdb_list, args.add_gap, args.ener_col, args.sep_complex, args.ener_data, args.adj_index)
    if len(test_ids) > 0:
